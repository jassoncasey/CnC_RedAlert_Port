 ...
 */
// RSA block size (312 bits / 8, rounded up)
constexpr size_t MIXKEY_RSA_BLOCK_SIZE = 39;
// Actually 78 used, but file has 80 bytes
constexpr size_t MIXKEY_ENCRYPTED_SIZE = 80;
